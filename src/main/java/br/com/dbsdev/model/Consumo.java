...
public class Consumo implements Serializable {
	...
	public Consumo(Long id, LocalDate dataAbastecimento, BigDecimal precoCombustivel, Double mediaConsumoParcial,
			Double mediaGeral10Dias, Double mediaConsumo, String tipoCombustivel, Double custoPorKm,
			BigDecimal custoTotal, String nomePosto, Double quantidadeLitros, Long odometroParcial, Veiculo veiculo) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Consumo [id=" + id + ", dataAbastecimento=" + dataAbastecimento + ", precoCombustivel="
				+ precoCombustivel + ", mediaConsumoParcial=" + mediaConsumoParcial + ", mediaGeral10Dias="
				+ mediaGeral10Dias + ", mediaConsumo=" + mediaConsumo + ", tipoCombustivel=" + tipoCombustivel
				+ ", custoPorKm=" + custoPorKm + ", custoTotal=" + custoTotal + ", nomePosto=" + nomePosto
				+ ", veiculo=" + veiculo + "]";
	}
